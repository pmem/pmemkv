 ...
 */
extern "C" {
static inline void call_destructor(void *object)
{
	auto *ptr = static_cast<unique_ptr_wrapper_base *>(object);
	delete ptr;
}

static inline void *call_get(void *object)
{
	auto *ptr = static_cast<unique_ptr_wrapper_base *>(object);
	return ptr->get();
}
				 ...
				 std::unique_ptr<T, D> object) noexcept
{
	...
	return static_cast<status>(pmemkv_config_put_object_cb(
		this->_config, key.data(), (void *)wrapper, internal::call_get,
		internal::call_destructor));
}
