 ...
 *creates the file, unless it exists - then it fails. If false: pmemkv opens the file
 *specified by 'path' (see config::put_path), unless the path does not exist - then it
