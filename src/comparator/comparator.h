...
class comparator {
public:
	comparator(void *arg, std::string name = "",
		   pmemkv_compare_function *cmp = nullptr)
	...
	void set_compare_function(pmemkv_compare_function *cmp)
	{
		this->cmp = cmp;
	}
...
{
	static const comparator cmp(nullptr, "__pmemkv_binary_comparator",
				    binary_compare);
	return cmp;
}
