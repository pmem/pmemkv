...
public:
	...
	size_t erase(pool_base &pop, const key_type &key, const key_compare &);
	template <typename K>
	size_t erase(pool_base &pop, K &&key, const key_compare &);
...
private:
	 ...
	 * default initialization and additional allocations */
	union {
