...
namespace internal
{
/* Wrapper class, which holds only pointer to memkind allocator instance, and
 * doesn't manage allocator's livecycle. Acctuall allocator instance has to be
 * sotred and managed elseware. This is needed as a workaroud for poor performance of
