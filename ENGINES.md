...
It is always enabled (no CMake option specified to enable/disable this engine).
...
It is enabled by default. It can be disabled in CMake using ENGINE_CMAP option.
...
It is enabled by default. It can be disabled in CMake using ENGINE_VSMAP option.
...
It is enabled by default. It can be disabled in CMake using ENGINE_VCMAP option.
...
It is disabled by default. It can be enabled in CMake using ENGINE_TREE3 option.
...
(TBD)
It is disabled by default. It can be enabled in CMake using ENGINE_STREE option.
...
(TBD)
It is disabled by default. It can be enabled in CMake using ENGINE_CACHING option.
