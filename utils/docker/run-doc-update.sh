...
REPO_NAME="pmemkv"
ARTEFACTS_DIR=$(mktemp -d -t ARTEFACTS-XXX)
...
cp -r ${REPO_DIR}/doc $ARTEFACTS_DIR/
cp -r ${REPO_DIR}/build/doc/cpp_html $ARTEFACTS_DIR/
...
cp -f $ARTEFACTS_DIR/doc/*.*.md ./${VERSION}/manpages/
cp -fr $ARTEFACTS_DIR/cpp_html/* ./${VERSION}/doxygen/
