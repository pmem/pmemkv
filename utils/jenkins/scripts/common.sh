...
function system_info {
	...
	echo "libpmem: $(pkg-config --modversion libfabric || echo 'libpmem not found')"
	echo "libpmemobj: $(pkg-config --modversion libfabric || echo 'libpmemobj not found')"
	echo "libpmemobj++,: $(pkg-config --modversion libfabric || echo 'libpmemobj not found')"
	echo "memkind: $(pkg-config --modversion libfabric || echo 'memkind not found')"
	echo "TBB : $(pkg-config --modversion libfabric || echo 'TBB not found')"
	echo "valgrind: $(pkg-config --modversion libfabric || echo 'valgrind not found')"
	echo "**********memory-info**********"
