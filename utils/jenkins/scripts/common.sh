...
function system_info {
	...
	uname -r
	echo "libndctl: $(pkg-config --modversion libndctl || echo 'libfabric not found')"
	echo "libfabric: $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "libpmem: $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "libpmemobj: $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "libpmemobj++,: $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "memkind: $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "TBB : $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "valgrind: $(pkg-config --modversion libfabric || echo 'libfabric not found')"
	echo "**********memory-info**********"
