...
#	and custom libraries. Executes 'build_test_libs' function.
...
function(build_test_ext)
	...
	build_test_libs(NAME ${TEST_NAME} SRC_FILES ${TEST_SRC_FILES} LIBS ${TEST_LIBS})
...
# Executes the 'build_test' function.
