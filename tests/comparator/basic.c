...
static void test_nullptr_comparator(const char *engine, pmemkv_config *cfg)
{
	int s = pmemkv_comparator_set_function(NULL, &reverse_three_way_compare);
...
int main(int argc, char *argv[])
{
	...
	test_nullptr_comparator(argv[1], C_CONFIG_FROM_JSON(argv[2]));
