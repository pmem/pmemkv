...
* **path** -- Path to the database file or to a poolset (see **poolset**(5) for details).
	+ type: string
...
Database file or poolset can also be created using pmempool utility (see **pmempool-create**(1)).
