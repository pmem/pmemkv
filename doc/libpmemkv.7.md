...
* **oid** -- Pointer to oid which points to engine data. If oid is null, engine will allocate new data, otherwise it will use existing data.
	+ type: object

The following table shows the interdependence of parameters:

| **path** | **force_create** | **size** | **oid** |
| -------- | ---------------- | -------- | ------- |
| specified | 0 | nonspecified | nonspecified |
| specified | 1 | specified | nonspecified |
| nonspecified | nonspecified | nonspecified | specified |
